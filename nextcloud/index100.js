...
execSync('for i in $(seq 1 100); do dd if=/dev/urandom of=/home/test/Nextcloud/testfile$i bs=1M count=3; done', {encoding:'utf-8'});


var watch1 = new INotifyWait('/var/www/html/nextcloud/data/test/files', { recursive: true });
